...
class SearchBar extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      otherSevaEventList: ["Surf Seva"],
      selectedOtherSevaEvent: "",
      showOtherSevaList: false,
      isOpen: false,
      isOtherSevaOpen: false,
      isOpenDayTime: false,
      selectedEvent: null,
  ...
  render() {
    ...
    const togglingOtherSeva = () =>
      this.setState({ isOtherSevaOpen: !this.state.isOpen });
    ...
    const onOptionClicked = (value) => () => {
      ...
      this.setState({ isOpen: false });
      console.log(value);
      if (value === "Other Seva" || value === "Seva - any Other") {
        this.setState({ showOtherSevaList: "true" });
      }

      // console.log(this.state.selectedEvent);
    };

    const onOtherSevaOptionClicked = (value) => () => {
      this.setState({ selectedOtherSevaEvent: value });
      this.setState({ isOtherSevaOpen: false });
    };
          ...
          <div className="App">
            <Container onClick={this.updateEvetToggle}>
              ...
              <div>
                ...
                {this.state.showOtherSevaList && (
                  <DropDownContainer>
                    <DropDownHeaderEvent onClick={togglingOtherSeva}>
                      {this.state.selectedOtherSevaEvent || "Select Other Seva"}
                    </DropDownHeaderEvent>
                    {this.state.isOtherSevaOpen && (
                      <DropDownListContainer>
                        <DropDownListEvent>
                          {this.state.otherSevaEventList?.map((event) => (
                            <ListItem
                              onClick={onOtherSevaOptionClicked(event)}
                              key={Math.random()}
                            >
                              {event}
                            </ListItem>
