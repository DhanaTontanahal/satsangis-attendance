...
class AutoCompleteSearchBoxLogin extends Component {
  ...
  onChange(e) {
    // console.log(e)
    const { suggestions, primaryIndex, secondaryIndex, tertiaryIndex } =
      this.props;
    ...
    const filteredSuggestions = suggestions.filter(suggestion => {
      return (
        suggestion[primaryIndex]
          .toLowerCase()
          .indexOf(userSearchInput.toLowerCase()) > -1 ||
        (suggestion[secondaryIndex] &&
          suggestion[secondaryIndex]
            .toLowerCase()
            .indexOf(userSearchInput.toLowerCase()) > -1) ||
        (suggestion[tertiaryIndex] &&
          suggestion[tertiaryIndex]
            .toLowerCase()
            .indexOf(userSearchInput.toLowerCase()) > -1)
      );
  ...
  onKeyDown(e) {
    ...
    if (e.keyCode === 13) {
      ...
      this.setState({
        showSuggestions: false,
        userInput:
          filteredSuggestions[activeSuggestions][this.props.secondaryIndex],
